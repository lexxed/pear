  ...
  <div class="container">
    <div class="nav-left">
      <a class="nav-item" href="{{ url('/') }}">
        <img src="{{ asset('img/pear_logo.png') }}" alt="travelpear">&nbsp;<strong><font class="pearlogo">Travelpear</font></strong>
      </a>
    </div>
...
<footer class="footer">
  <div class="container">
    <div class="has-text-centered">
      <p>
        <a href="{{ url('/') }}"><strong>Travelpear&nbsp;</strong></a>© Copyright {{ date("Y")}}
      </p>
      <p class="text-muted">
